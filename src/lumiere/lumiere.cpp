...
// {
//     glm::mat4 lumiereMatrix = glm::translate(viewMatrix,
//     this->_environmentPosition); this->_position       =
//     glm::vec3((lumiereMatrix)*glm::vec4(0, 0, 0, 1));
// }

// void DirectionalLumiere::update(const glm::mat4& viewMatrix)
// {
//     this->_position =
//     glm::vec3((viewMatrix)*glm::vec4(this->_environmentPosition, 0.f));
// }