...
//     DirectionalLumiere(const DirectionalLumiere&)                    =
//     default; DirectionalLumiere(DirectionalLumiere&&) = delete; auto
//     operator=(const DirectionalLumiere&) -> DirectionalLumiere& = default;
//     auto operator=(DirectionalLumiere&&) -> DirectionalLumiere&      =
//     delete; explicit DirectionalLumiere(const glm::vec3& position); void
//     update(const glm::mat4& viewMatrix) override;
// };